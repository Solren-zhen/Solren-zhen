# Med AI undergraduate · 医工结合 in progress

Clinical medicine undergraduate (China) · working at the intersection of
**medicine and AI engineering**.
...
| [Thyroid US AI](https://github.com/Solren-zhen/thyroid-nodule-classification) | How large is the cross-dataset domain-shift gap in thyroid ultrasound AI (4 public cohorts), and do structured features (ACR TI-RADS) help? Joint training recovers ~45% of the external loss; fusion ΔAUC +0.022 (p<0.001). | manuscript in preparation (STARD 2015 / TRIPOD+AI checklists) |
...
prediction · bootstrap/paired testing · Streamlit/Gradio ·
clinical rotations (internal medicine, surgery)

📫 open a GitHub issue or discussion on any of the repos above.
